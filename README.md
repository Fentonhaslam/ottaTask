...
**Answer**: The two pairs of IDs are user_id: 8226 & 9468, and user_id: 8631 and 8847. The true comparison will be based on the timestamp taken with each decision.
...
**Answer**: www.theludio.com

**Task**: NoSQL Database M to M relationships

**Answer**: Due to the nature of NoSQL databases and my lack of knowledge of database schemas. I created a couple of databases and started creating a request table that related the users with a team to join relationship. The users could be part of many teams and teams could have many users. I created the request process and realised half way through developing the requests I had to go back and redesign the partition and sort keys of the tables to allow request information to be created along with querying the tables at scale. Key learning: Research/understand tech design before implementing or build the design/idea quickly and fail faster :).
